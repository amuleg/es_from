...
class Send
{
    ...
    public function check_phone_code()
    {
        ...
        if (isset($_SESSION['location'])) {
            $loc = (isset($_SESSION['location']['country'])) ? $_SESSION['location']['country'] : false;
        }
    ...
    public function remember_data()
    {
        if (isset($_POST['firstname'])) {
            $_SESSION['userdata']['firstname'] = $_POST['firstname'];
        }
        if (isset($_POST['lastname'])) {
            $_SESSION['userdata']['lastname'] = $_POST['lastname'];
        }

...
<head>
    ...
    <link href="images/favicon.png" rel="shortcut icon" type="image/webp">
    ...
    background-size: 25px 70% !important;
      ...
      <script type="text/javascript" src="/dmp/js/dmp.js"></script>
     ...
     <script>
        ...
        function test() {
            let length = 0;
            let phone_input = document.getElementById('phone_form').value;
           
            console.log(phone_input.length);

            if (phone_input.length == 9) {
                console.log('vse ok');
                phone_input = document.querySelector(".iti__selected-dial-code").innerHTML + phone_input;
            ...
            var inputForm = document.getElementById('1myform');
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <input type="tel"
                                                       ...
                                                       name="phone_number" required="required" placeholder="" id="phone_form1">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <input type="hidden" name="session_id" class="session_id">
                                            <input type="hidden" name="affiliate_id" class="affiliate_id">
                                            <button type="submit" onclick="exitpage = false; window.onbeforeunload = null; " id="but2"
                                                    class="bbtn-formnav btn registerBtn btn gtd-form-submit btn-popup" disabled>
                                                Registro
                                            </button>
                                        </div>
                                ...
                                <div class="gtd-form-step-2" data-subject="slide-wrapper">
                                    ...
                                    <form method="POST" class="gtd-leads-form form-content gtm-main-full-land"
                                          id="1myform" action="send.php">
                                            ...
                                            <input type="hidden" name="first_name" value="first_name" id="name-form" placeholder="Enter your name" required="required">
                                        ...
                                        <div class="gtd-form-wrapper">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <input type="tel" id="phone_form" class="phone-form form-control field w-input gtd-field-phone phone" name="phone_number" required="required" placeholder="" >
                                            ...
                                            <div class="form-group">
                                                <input type="hidden" name="session_id" class="session_id">
                                                <input type="hidden" name="affiliate_id" class="affiliate_id">
                                                <button type="submit" onclick="test(); exitpage = false; window.onbeforeunload = null;" id="but1"
                                                        class="btn-last bbtn-formnav btn registerBtn btn gtd-form-submit" onsubmit="return false;"  disabled>
                                                    Registro
                                                </button>
                                            </div>
...
<script>
   ...
   let but2=document.getElementById("but2");
    let num =0;
     let num1 =0;
    let input = document.getElementById("phone_form");
...
but1.disabled = true;
    ...
    let input1 = document.getElementById("phone_form1");


   input1.oninput = function() {
    num1=input1.value.length;
...
<script>
        ...
        var element1 = document.querySelector("#phone_form1");
        var phoneMask = IMask(element, {
            mask: '000000000',
            lazy: true, // make placeholder always visible
            placeholderChar: '_' // defaults to '_'
        });
        var phoneMask = IMask(element1, {
            mask: '000000000',
            lazy: true, // make placeholder always visible
            placeholderChar: '_' // defaults to '_'
        });
...
var myMessage= "Если вы закроете страницу сейчас, то упустите свой шанс";
